...
public class RecordOperation implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RecordOperation other = (RecordOperation) obj;
		return Objects.equals(arguments, other.arguments) && Objects.equals(fnName, other.fnName);
	}
	@Override
	public String toString() {
		return "RecordOperation [fnName=" + fnName + ", arguments=" + arguments + "]";
	}
	public RecordOperation(String fnName, String arguments) {
		super();
		this.fnName = fnName;
		this.arguments = arguments;
	}
